...
'''
        ...
        try:
            interface_dir = self.src_path / "application" / "services" / "ai" / "interfaces"
...
'''
        ...
        try:
            transcription_file = self.src_path / "application" / "services" / "audio" / "transcription_service.py"
...
'''
        ...
        try:
            use_cases_dir = self.src_path / "application" / "services" / "core" / "use_cases"
