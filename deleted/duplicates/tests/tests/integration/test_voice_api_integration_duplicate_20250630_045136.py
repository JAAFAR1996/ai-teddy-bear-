...
class TestESP32AudioEndpoint:
    ...
    def test_esp32_audio_endpoint_with_mp3_file(self, client, sample_mp3_bytes, mock_transcription_result, mock_ai_response):
    ...
    def test_esp32_audio_endpoint_with_wav_file(self, client, sample_wav_bytes, mock_transcription_result, mock_ai_response):
...
class TestVoiceServiceHealth:
    ...
    def test_voice_service_dependency_injection(self, client):
        ...
        with patch('src.api.endpoints.voice.create_voice_service') as mock_create:
            ...
            from src.api.endpoints.voice import get_voice_service
...
class TestAPIPerformance:
    ...
    def test_esp32_audio_processing_performance(self, client, sample_mp3_bytes, mock_transcription_result, mock_ai_response):
...
class TestAPIErrorHandling:
    ...
    def test_invalid_audio_format(self, client, sample_mp3_bytes):
        ...
        data = {
            ...
            "audio_format": "invalid_format"  # Invalid format
        }
...
class TestAPISecurity:
    ...
    def test_sql_injection_attempt_in_device_id(self, client, sample_mp3_bytes):
        ...
        with patch('src.api.endpoints.voice.get_voice_service') as mock_voice_service, \
            ...
            data = {
                "device_id": "'; DROP TABLE devices; --",  # SQL injection attempt
                "audio_format": "mp3"
            }
