...
class RolePermissions:
    ...
    PERMISSIONS = {
        UserRole.SUPER_ADMIN: {
            Permission.READ_CHILD, Permission.WRITE_CHILD, Permission.DELETE_CHILD,
            Permission.READ_CONVERSATION, Permission.WRITE_CONVERSATION, Permission.DELETE_CONVERSATION,
            Permission.READ_AI_PROFILE, Permission.WRITE_AI_PROFILE,
            Permission.READ_SAFETY, Permission.WRITE_SAFETY,
            Permission.READ_MONITORING,
            Permission.ADMIN_USERS, Permission.ADMIN_SYSTEM, Permission.VIEW_METRICS
        },
        UserRole.ADMIN: {
            Permission.READ_CHILD, Permission.WRITE_CHILD,
            Permission.READ_CONVERSATION, Permission.WRITE_CONVERSATION,
            Permission.READ_AI_PROFILE, Permission.WRITE_AI_PROFILE,
            Permission.READ_SAFETY, Permission.WRITE_SAFETY,
            Permission.READ_MONITORING,
        ...
        UserRole.SERVICE: {
            ...
            Permission.READ_CONVERSATION, Permission.WRITE_CONVERSATION,
            Permission.READ_AI_PROFILE, Permission.WRITE_AI_PROFILE,
            Permission.READ_SAFETY, Permission.READ_MONITORING
        }
    }
