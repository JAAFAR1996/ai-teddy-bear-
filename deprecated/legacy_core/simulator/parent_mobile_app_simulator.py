...
class ParentMobileAppSimulator:
    ...
    def _create_device_control_tab(self):
    ...
    def _send_volume_to_device(self, volume):
    ...
    def _on_child_select(self, event):
        """عند اختيار طفل"""
    ...
    def _load_child_details(self, child_name):
        """تحميل تفاصيل الطفل"""
...
"""
    ...
    def _create_sample_charts(self, parent):
        """إنشاء مخططات عينة"""
        # Daily Usage Chart
