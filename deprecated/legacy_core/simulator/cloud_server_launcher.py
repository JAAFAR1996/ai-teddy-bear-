...
class CloudServerLauncher:
    ...
    def _create_monitoring_tabs(self, parent):
        """تبويبات المراقبة"""
    ...
    def _create_stat_display(self, parent, title, key, unit, row, col):
        """إنشاء عرض إحصائي"""
    ...
    def _create_connections_tab(self, notebook):
    ...
    def _update_detailed_system_info(self):
...
"""
    ...
    def _update_system_info_display(self, info):
