...
from .vault_secrets_manager import get_vault_manager, VaultSecretsManager
from .rbac_system import get_rbac_manager, RBACManager, UserRole, Permission
from .api_security_gateway import get_security_gateway, APISecurityGateway
from .audio_security import get_audio_encryption_manager, AudioEncryptionManager
from .jwt_auth import get_jwt_manager, JWTManager, UserClaims, TokenPair
...
class SecurityManager:
    ...
    # RBAC Operations
    async def create_parent_user(self, user_id: str, username: str, 
                                family_id: str, parent_id: Optional[str] = None):
    ...
    async def create_child_user(self, user_id: str, username: str,
                               family_id: str, parent_id: str):
    ...
    async def authenticate_parent(self, user_id: str, username: str, 
                                 email: str, family_id: str) -> TokenPair:
    ...
    async def authenticate_child(self, user_id: str, username: str,
                                email: str, family_id: str, device_id: str) -> TokenPair:
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'components': {
                ...
                'audio_encryption': {'status': 'healthy', 'active_sessions': len(self.audio_encryption.active_sessions)},
...
async def authenticate_family_member(username: str, password: str, 
                                   role: str, family_id: str,
