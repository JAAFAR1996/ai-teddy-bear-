...
from .data_cleanup_service import run_daily_cleanup, preview_cleanup
...
class SchedulerService:
    ...
    async def _run_data_cleanup(self):
        ...
        try:
            ...
            self.logger.info("Daily data cleanup completed", 
    ...
    async def _monitor_data_status(self):
        ...
        try:
            ...
            if total_items > 10000:  # تنبيه إذا كان هناك كمية كبيرة
                self.logger.warning("Large amount of data pending cleanup", 
                                  total_items=total_items)
            
            self.logger.debug("Data status monitored", 
                            items_pending_cleanup=total_items)
    ...
    async def _daily_system_report(self):
        ...
        try:
            ...
            # إحصائيات سريعة
            from database import SessionRecord, Emotion, ChildProfile
            ...
            self.logger.info("Daily system report generated",
    ...
    def add_custom_job(self, func, trigger, job_id: str, **kwargs):
        ...
        try:
            ...
            self.logger.error("Failed to add custom job", 
    ...
    def remove_job(self, job_id: str):
        ...
        try:
            ...
            self.logger.error("Failed to remove job", 
                            job_id=job_id, error=str(e))
