...
class ProjectValidator:
        ...
        for py_file in self.src_dir.rglob("*.py"):
            try:
                ...
                try:
                    ...
                    if broken_imports:
                        import_results.append(ValidationResult(
    ...
    def validate_file_structure(self) -> List[ValidationResult]:
        ...
        for dir_name in required_dirs:
            ...
            if not dir_path.exists():
                structure_results.append(ValidationResult(
    ...
    def validate_config_files(self) -> List[ValidationResult]:
        ...
        for config_file in config_files:
            ...
            if not config_path.exists():
                config_results.append(ValidationResult(
        ...
        for file_path in self.src_dir.rglob("*"):
            if file_path.is_file() and file_path.stat().st_size == 0:
                ...
                if file_path.name == "__init__.py":
                    empty_results.append(ValidationResult(
    ...
    def run_full_validation(self) -> Dict[str, any]:
        ...
        logger.info(f"[COMPLETE] انتهى الفحص - النجاح: {self.success_count}, تحذيرات: {self.warnings_count}, أخطاء: {self.errors_count}")
    ...
    def generate_validation_report(self) -> str:
        ...
        report_path = Path("deleted/reports") / f"validation_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.md"
