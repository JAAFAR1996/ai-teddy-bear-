...
class SecurityScanner:
    ...
    def run_bandit_scan(self, directory: str = 'src') -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'issues_by_severity': self._categorize_bandit_issues(bandit_results['results'])
            }
    ...
    def run_safety_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'vulnerabilities_by_severity': self._categorize_safety_issues(safety_results)
            }
    ...
    def run_trufflehog_scan(self, repository_path: str = '.') -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'secrets_by_type': self._categorize_trufflehog_secrets(trufflehog_results)
            }
    ...
    def _export_report(self, report: Dict[str, Any], output_path: str = 'security_reports/comprehensive_report.json'):
        """
        ...
        try:
            ...
            self._logger.info(f"Comprehensive security report exported to {output_path}")
        except Exception as e:
...
def main():
    ...
    parser.add_argument('--safety', action='store_true', help='Run Safety dependency check')
    parser.add_argument('--trufflehog', action='store_true', help='Run Trufflehog secret scan')
    parser.add_argument('--comprehensive', action='store_true', help='Run comprehensive security scan')
