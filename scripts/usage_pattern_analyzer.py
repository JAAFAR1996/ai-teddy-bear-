...
class UsagePatternAnalyzer:
    ...
    def generate_smart_merge_recommendations(self, service_usage: Dict, classification: Dict) -> Dict:
        ...
        for group_name, group_services in groups.items():
            ...
            print(f"  🎯 الخدمة الأساسية: {primary_service_name} ({primary_service_data['usage_count']} مراجع)")
            ...
            for service_name, service_data in sorted_services[1:]:
                if service_data["usage_count"] == 0:
                    ...
                    recommendations["merge_into_primary"].setdefault(group_name, []).append({
                        "service": service_name,
                        "usage_count": service_data["usage_count"],
                        "reason": "استخدام قليل، يمكن دمجه"
                    })
                    print(f"    🔄 للدمج: {service_name} ({service_data['usage_count']} مراجع)")
                    ...
                    print(f"    📝 مراجعة: {service_name} ({service_data['usage_count']} مراجع)")
    ...
    def execute_usage_based_organization(self, recommendations: Dict) -> Dict:
        ...
        try:
            ...
            for item in recommendations["safe_to_delete"]:
                ...
                source_path = self.base_path / "deprecated" / "services" / group_name / f"{service_name}.py"
    ...
    def generate_usage_analysis_report(self, service_usage: Dict, classification: Dict, 
                                     recommendations: Dict, results: Dict) -> str:
...
"""
    ...
    def run_complete_usage_analysis(self) -> Dict:
        ...
        # إنشاء توصيات الدمج
        recommendations = self.generate_smart_merge_recommendations(service_usage, classification)
        ...
        report_path = self.base_path / "deleted" / "reports" / "USAGE_PATTERN_ANALYSIS.md"
