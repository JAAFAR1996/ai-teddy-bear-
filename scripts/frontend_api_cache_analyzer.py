...
class FrontendAPICacheAnalyzer:
    ...
    def analyze_mypy_cache(self) -> Dict:
        ...
        if analysis["total_size"] > 10 * 1024 * 1024 or analysis["total_files"] > 100:
            ...
            print(f"  ⚠️  يمكن تنظيف cache: {analysis['total_files']} ملف، {analysis['total_size'] / (1024*1024):.1f} MB")
    ...
    def analyze_frontend_structure(self) -> Dict:
        ...
        if nested_frontend.exists():
            ...
            for item in frontend_dir.iterdir():
                ...
                elif item.is_dir() and item.name != "frontend":  # تجاهل المجلد المتداخل نفسه
...
"""
    ...
    def run_analysis(self) -> Dict:
        ...
        report_path = self.base_path / "deleted" / "reports" / "FINAL_FRONTEND_API_CACHE_CLEANUP_REPORT.md"
        ...
        print(f"💾 المساحة الموفرة: {self.report['stats']['space_saved'] / (1024*1024):.2f} MB")
...
def main():
    ...
    try:
        ...
        print(f"📋 تقرير مفصل: deleted/reports/FINAL_FRONTEND_API_CACHE_CLEANUP_REPORT.md")
