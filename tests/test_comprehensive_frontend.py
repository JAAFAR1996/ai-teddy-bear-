...
class TestConversations:
    ...
    async def test_conversation_details(self, conversation_service):
        ...
        conversation_details = {
            ...
            "duration": 300,
            "transcript": [
                {"speaker": "child", "text": "Tell me a story", "timestamp": "2024-01-01T10:00:10Z"},
                {"speaker": "teddy", "text": "Once upon a time...", "timestamp": "2024-01-01T10:00:15Z"}
            ],
            "emotions": [
                {"emotion": "happy", "confidence": 0.85, "timestamp": "2024-01-01T10:00:10Z"},
                {"emotion": "excited", "confidence": 0.75, "timestamp": "2024-01-01T10:02:00Z"}
            ]
        }
    ...
    async def test_conversation_search(self, conversation_service):
        ...
        conversation_service.search_conversations = AsyncMock(return_value=search_results)
