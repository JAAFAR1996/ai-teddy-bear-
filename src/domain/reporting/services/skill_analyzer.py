...
class SkillAnalyzer:
    ...
    def _count_skill_usage(
            self,
            interactions: List[InteractionAnalysis]) -> Counter:
    ...
    def _recommend_to_strengthen_top_skills(
            self, skill_counts: Counter) -> List[str]:
