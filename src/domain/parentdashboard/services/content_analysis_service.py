...
from ..models.alert_models import AlertType, AlertSeverity
...
class ContentAnalysisService:
    ...
    def __init__(self):
        self.emergency_keywords = {
            'help', 'emergency', 'hurt', 'scared', 'danger', 'pain',
            'bleeding', 'fire', 'police', 'ambulance', 'hospital'
        }
        
        self.concerning_keywords = {
            'sad', 'crying', 'angry', 'hate', 'bullying', 'mean',
            'alone', 'nobody likes me', 'want to die', 'suicide'
        }
        
        self.inappropriate_keywords = {
            'violence', 'weapon', 'gun', 'knife', 'kill', 'murder',
            'adult content', 'sexual', 'drugs', 'alcohol', 'smoking'
        }
    ...
    def _detect_sentiment_decline(
        ...
        early_avg = sum(
            conv.sentiment_scores.get('positive', 0) 
    ...
    def _detect_isolation_indicators(
        ...
        isolation_keywords = {
            'lonely', 'alone', 'no friends', 'nobody likes me',
            'by myself', 'no one to play with'
        }
