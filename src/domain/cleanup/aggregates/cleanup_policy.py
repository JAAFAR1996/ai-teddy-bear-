...
class CleanupPolicy:
    ...
    def add_rule(self, data_category: str, retention_days: int, 
        ...
        logger.info("Policy rule added", policy_id=self.policy_id,
                   data_category=data_category, retention_days=retention_days)
    ...
    def activate(self, activated_by: str) -> None:
        ...
        logger.info("Cleanup policy activated", 
                   policy_id=self.policy_id, activated_by=activated_by)
