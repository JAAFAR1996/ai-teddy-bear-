...
class DataRetentionPolicy:
    ...
    def is_gdpr_compliant(self) -> bool:
        ...
        return (
            self.gdpr_compliant
            and self.conversations_retention_days <= 30
            and self.backup_before_delete
            and self.notify_parents_before_delete
        )
    ...
    def is_coppa_compliant(self) -> bool:
        ...
        return (
            ...
            and self.conversations_retention_days <= 14
            and self.audio_files_retention_days <= 7
            and self.require_parent_confirmation
        )
