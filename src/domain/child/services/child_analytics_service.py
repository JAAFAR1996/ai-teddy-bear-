...
class ChildAnalyticsDomainService:
    ...
    def calculate_statistics(
        self,
        children: List[Child],
        active_children_last_7_days: int
    ) -> ChildStatistics:
        """
    ...
    def calculate_learning_progress_score(self, child: Child) -> float:
        ...
        profile_fields = [
            child.name, child.age, child.interests, child.personality_traits,
            child.learning_preferences, child.communication_style
        ]
