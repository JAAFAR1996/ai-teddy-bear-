...
try:
    from .ai_test_generator import AITestGenerator, GeneratedTest, TestGenerationConfig
    ...
    def _create_test_scenarios(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "contexts": [ChildContext(age=5, emotion="confused"), ChildContext(age=12, emotion="frustrated")],
            },
        ]
...
'''
    ...
    async def _demo_mutation_testing(self):
        ...
        original_inputs = ["tell me a story", "help with homework", "what's the weather?"]
...
'''
    ...
    async def _generate_demo_report(self):
        ...
        report_data = {
            ...
            "summary": {"total_tests": total_tests, "issues_found": total_issues_found, "overall_success": True},
        }
