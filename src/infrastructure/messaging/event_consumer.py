...
from .kafka_config import KafkaConsumerConfig, KafkaTopics, KAFKA_CONFIG
...
class KafkaEventConsumer:
    ...
    async def _process_message(self, message) -> None:
        ...
        try:
            ...
            for handler in handlers:
                try:
                    ...
                    if success:
                        ...
                        logger.warning(f"Handler {handler.__class__.__name__} failed for event {consumed_event.event_type}")
                except Exception as e:
            ...
            logger.debug(f"Processed event {consumed_event.event_type} "
    ...
    def _should_commit_offsets(self) -> bool:
        ...
        return (
            self._metrics['events_processed'] % 100 == 0 or
            (datetime.utcnow().timestamp() % 30) < 1
        )
