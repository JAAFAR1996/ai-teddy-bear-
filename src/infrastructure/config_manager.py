...
class ConfigManager:
    ...
    def __init__(self, config_path: Optional[str] = None, base_dir: Optional[str] = None):
        ...
        if config_path:
            ...
            if not hasattr(self, "config_path"):
                raise FileNotFoundError("No config file found in any expected location")
    ...
    def _apply_environment_overrides(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        env_overrides = {
            ...
            "staging": {"APPLICATION": {"DEBUG": False}, "LOGGING_CONFIG": {"LOG_LEVEL": "INFO"}},
            "development": {"APPLICATION": {"DEBUG": True}, "LOGGING_CONFIG": {"LOG_LEVEL": "DEBUG"}},
        }
    ...
    def load_app_config(path: str = "config/config.json") -> AppConfig:
        ...
        with open(path, "r", encoding="utf-8") as f:
            ...
            voice_settings = VoiceSettings(**config_dict.get("VOICE_SETTINGS", {}))
            # أنشئ AppConfig وأرسل له voice_settings
            app_config = AppConfig(
                environment=config_dict.get("APPLICATION", {}).get("ENVIRONMENT", "development"),
...
def main():
    ...
    parser.add_argument("--type", choices=["json", "yaml"], default="json", help="Configuration file type")
