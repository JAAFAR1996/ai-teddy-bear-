                ...
                for i in range(daily_interactions):
                    interaction = InteractionAnalysis(
                        ...
                        topics_discussed=random.sample([
                            'stories', 'games', 'animals', 'colors', 'numbers', 
                            'family', 'friends', 'school', 'food', 'toys'
                        ], random.randint(1, 3)),
                        skills_used=random.sample([
                            'listening', 'speaking', 'counting', 'reading', 
                            'problem_solving', 'creativity', 'social_skills'
                        ], random.randint(1, 4)),
                        behavioral_indicators=random.sample([
                            'engaged', 'attentive', 'cooperative', 'responsive',
                            'creative', 'patient', 'curious'
                        ], random.randint(1, 3)),
