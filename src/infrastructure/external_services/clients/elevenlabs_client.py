...
try:
    from elevenlabs import ElevenLabs, generate, stream, VoiceSettings
except ImportError:
    from src.infrastructure.external_services.mock.elevenlabs import ElevenLabs, generate, stream, VoiceSettings
