...
class RateMonitorService:
    ...
    async def record_notification(self, parent_email: str, child_udid: str, 
                                channel: str, success: bool, error_message: str = None):
        """تسجيل إرسال إشعار"""
        try:
            now = datetime.utcnow()
            ...
            self.logger.info("Notification recorded", 
                           parent_email=parent_email, success=success)
...
async def record_notification_sent(parent_email: str, child_udid: str, channel: str, success: bool, error_message: str = None):
    """تسجيل إرسال إشعار"""
