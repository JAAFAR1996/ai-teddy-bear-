...
def get_jwt_manager(secret_key: Optional[str] = None,
                   redis_client: Optional[redis.Redis] = None) -> JWTManager:
...
async def authenticate_parent(user_id: str, username: str, email: str, 
                             family_id: str) -> TokenPair:
...
async def authenticate_child(user_id: str, username: str, email: str,
                            family_id: str, device_id: str) -> TokenPair:
