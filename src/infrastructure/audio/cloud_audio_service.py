...
class CloudAudioService:
    ...
    async def _generate_fallback_response(self, message: str) -> Dict[str, str]:
        ...
        fallback_responses = {
            ('hello', 'hi', 'مرحبا'): "Hello my little friend! I'm so happy to talk with you today! 🧸💕",
            ('play', 'game', 'العب'): "Let's play together! Would you like me to tell you a story or sing a song? 🎵",
            ('story', 'قصة'): "Once upon a time, there was a magical teddy bear who loved to make children smile... ✨",
            ('sad', 'upset', 'حزين'): "Aww, don't be sad little one. I'm here for you always. Let's think of happy things! 🌈",
        }
