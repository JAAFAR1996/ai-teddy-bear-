...
from typing import Callable, Type, Dict, Any, Optional, List, Union
import asyncio
...
from src.domain.exceptions.base import (
    ...
    ErrorCategory, CircuitBreakerOpenException
)
from src.infrastructure.monitoring.alert_manager import AlertManager
from src.infrastructure.monitoring.metrics import (
    error_counter, circuit_breaker_state, MetricsCollector
)
        ...
        async with self._lock:
            ...
            if total_requests > 0:
                ...
                if (self.stats.failure_count >= self.failure_threshold or
                    error_percentage >= self.error_threshold_percentage):
                    if self.state != CircuitState.OPEN:
