...
from PySide6.QtWidgets import (
    ...
    QLabel, QProgressBar, QListWidget, QTextEdit, QComboBox,
    QPushButton, QCheckBox, QSlider, QTabWidget, QSplitter
)
...
class EmotionAnalyticsEngine:
    ...
    def get_emotion_insights(self) -> Dict[str, Any]:
        ...
        if len(recent_emotions) >= 10:
            ...
            first_avg = sum(1 if e["emotion"] in ["happy", "excited", "calm"] else 0 for e in first_half) / len(first_half)
            second_avg = sum(1 if e["emotion"] in ["happy", "excited", "calm"] else 0 for e in second_half) / len(second_half)
...
class EnterpriseDashboardWidget(QWidget):
    ...
    def update_current_emotion_display(self, emotion: str, confidence: float):
        ...
        emotion_colors = {
            ...
            "angry": "#fce4ec", "surprised": "#fff8e1", "neutral": "#f5f5f5"
        }
