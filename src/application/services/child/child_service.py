...
from ....domain.esp32.models import (
    ChildProfile, SessionData, ConversationEntry, 
        ...
        try:
            ...
            summary = {
                ...
                "current_session": {
                    ...
                    "session_id": self.current_profile.current_session.session_id if self.current_profile.current_session else None,
                    "duration_minutes": self.current_profile.current_session.duration_minutes if self.current_profile.current_session else 0,
                    "interaction_count": self.current_profile.current_session.interaction_count if self.current_profile.current_session else 0
                },
