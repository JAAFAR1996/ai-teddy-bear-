...
from .enums import AIProvider, EmotionType, MessageCategory, ResponseSafety
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "safety_level": (
                ...
                if isinstance(self.safety_level, ResponseSafety)
            ...
            "category": (
                self.category.value
                if isinstance(self.category, MessageCategory)
                else self.category
            ),
...
class EmotionResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "primary_emotion": (
                self.primary_emotion.value
                if isinstance(self.primary_emotion, EmotionType)
                else self.primary_emotion
            ),
            "confidence": self.confidence,
...
class ConversationSession:
    ...
    def add_message(
        self, message: str, response: str, emotion: str, metadata: Optional[Dict] = None
    ):
