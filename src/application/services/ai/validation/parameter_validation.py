...
class LLMParameterValidator:
    ...
    def validate_core_parameters(
        self, conversation: Conversation, max_tokens: int, temperature: float
    ) -> None:
    ...
    def validate_optional_parameters(
        self, provider: Optional[LLMProvider], model: Optional[str]
    ) -> None:
    ...
    def validate_all_parameters(
        self, params: "LLMParameterValidator.ValidationParameters"
    ) -> None:
        """Validate all parameters - single entry point"""
        # Refactoring: Using parameter object to reduce arguments
        self.validate_core_parameters(
            params.conversation, params.max_tokens, params.temperature
        )
