...
class TranscriptionService:
    ...
    async def transcribe_with_fallback(
        ...
        async def _try_transcription():
            ...
            for service_name, service in transcription_services:
                result = await self._attempt_transcription(service, audio_data, language, service_name)
                if result:
                    return result
    ...
    async def _attempt_transcription(self, service, audio_data: bytes, language: str, service_name: str):
