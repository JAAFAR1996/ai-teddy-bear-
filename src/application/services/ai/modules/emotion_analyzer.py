...
class EmotionAnalyzer:
    ...
    def __init__(self, ai_service=None):
        ...
        self.emotion_keywords = {
            "happy": ["happy", "glad", "excited", "joy", "fun", "great", "awesome", "love"],
    ...
    async def analyze_audio(self, audio_data: bytes) -> Optional[EmotionResult]:
    ...
    def _combine_emotion_results(
        ...
        combined_confidence = (text_emotion.confidence * 0.6 + 
                             audio_emotion.confidence * 0.4)
        
        combined_valence = (text_emotion.valence * 0.6 + 
                           audio_emotion.valence * 0.4)
        
        combined_arousal = (text_emotion.arousal * 0.6 + 
                           audio_emotion.arousal * 0.4)
