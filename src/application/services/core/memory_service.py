...
class MemoryService:
    ...
    async def store_interaction(self, session_id: str, user_message: str, 
                              ai_response: str, metadata: Dict[str, Any]):
    ...
    async def recall_memories(self, child_id: str, query: str, 
    ...
    async def get_conversation_context(self, child_id: str, 
    ...
    async def update_child_profile(self, child_id: str, 
    ...
    async def forget_memories(self, child_id: str, 
                            older_than_days: Optional[int] = None,
                            importance_threshold: Optional[MemoryImportance] = None) -> int:
