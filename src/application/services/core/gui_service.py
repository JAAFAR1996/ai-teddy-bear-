...
from ....domain.esp32.models import ESP32Device, AudioVisualization
...
class GUIManagementService:
        ...
        try:
            ...
            if 'led_canvas' in self.gui_components and 'led_circle' in self.gui_components:
                ...
                self.gui_components['led_canvas'].itemconfig(
                    self.gui_components['led_circle'], 
                    fill=led_color
                )
    ...
    def _create_status_panel(self) -> None:
        ...
        server_status_label = tk.Label(info_frame, text=" Server: Disconnected", bg='#ecf0f1', font=('Arial', 10), fg='red')
    ...
    def _create_child_panel(self) -> None:
        ...
        save_button = tk.Button(profile_frame, text=" Save Profile", command=self._on_save_profile, bg='#9b59b6', fg='white')
    ...
    def _create_features_panel(self) -> None:
        ...
        for i, (text, command) in enumerate(test_buttons):
            btn = tk.Button(features_grid, text=text, command=command, 
