...
from src.domain.parentdashboard.models.alert_models import Alert, AlertType, AlertSeverity
    ...
    async def process_moderation_alert(
        ...
        alert = await self.create_alert(
            ...
            details={
                ...
                'conversation_excerpt': conversation_content[:200] + "..." if len(conversation_content) > 200 else conversation_content,
