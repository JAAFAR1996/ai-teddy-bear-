...
class IssueTrackerService:
    ...
    async def create_issue(self, title: str, description: str, 
                          severity: str = "medium", component: str = "unknown",
                          error_type: str = "runtime_error", 
                          stacktrace: str = None) -> str:
...
# دوال مساعدة
async def report_issue(title: str, description: str, severity: str = "medium", 
                      component: str = "unknown", error_type: str = "runtime_error") -> str:
    """تسجيل مشكلة جديدة"""
