...
class MathemythsEngine:
    ...
    def get_appropriate_challenge(self, child_age: int, subject: SubjectType, 
                                child_name: str, device_id: str) -> Optional[EducationalChallenge]:
    ...
    def integrate_challenge_into_story(self, story_content: str, challenge: EducationalChallenge,
                                     child_name: str, position: str = "middle") -> StoryEducationalInsert:
        ...
        # اختيار انتقال مناسب
        subject_transitions = narrative_transitions.get(challenge.subject.value, [
            f"واجه {child_name} تحدياً جديداً:"
        ])
    ...
    async def process_challenge_response(self, challenge_id: str, user_answer: str,
                                       child_name: str, device_id: str) -> Dict[str, Any]:
    ...
    async def _update_learning_progress(self, child_name: str, device_id: str,
                                      challenge: EducationalChallenge, correct: bool):
    ...
    def generate_adaptive_story_with_challenges(self, child_name: str, age: int, 
                                              interests: List[str], device_id: str) -> Dict[str, Any]:
    ...
    def _generate_base_educational_story(self, child_name: str, age: int, 
...
عاد {child_name} إلى البيت وهو أكثر علماً وحكمة!
    ...
    def _integrate_challenges_into_story(self, base_story: str, challenges: List[EducationalChallenge],
                                       child_name: str) -> str:
